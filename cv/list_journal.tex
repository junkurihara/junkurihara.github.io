\begin{enumerate}
  \item S.~Hashimoto, T.~Tanaka, \underline{J.~Kurihara}, ``A Monitoring Mechanism t o Realize the Byzantine Resilience in Federated Learning via Client Tracking'', to Appear in \textit{IPSJ Journal}, vol.~66, no.~12, pp.~1--12, Dec. 2025. (in Japanese)
