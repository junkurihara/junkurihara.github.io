\begin{enumerate}
  \item R.~Aoshima, \underline{J.~Kurihara}, T.~Tanaka, ``Aggregable generalized deduplication,'' \textit{IEICE Transactions on Communications}, vol.~E109-B, no.~3, pp.~389--399, Mar. 2026.
  \item K.~Nakano, \underline{J.~Kurihara} and T.~Tanaka, ``Extensive study on the security of private information delivery from coded storage,'' \textit{IEICE Transactions on Fundamentals of Electronics, Communications and Computer Sciences}, vol.~E109-A, no.~3, pp.~725--733, Mar. 2026.
  \item S.~Hashimoto, T.~Tanaka, \underline{J.~Kurihara}, ``A Monitoring Mechanism t o Realize the Byzantine Resilience in Federated Learning via Client Tracking,'' \textit{IPSJ Journal}, vol.~66, no.~12, pp.~1827--1840, Dec. 2025. (in Japanese)
