\begin{enumerate}
 \item K.~Ueda, K.~Yokota, \underline{J.~Kurihara}, A.~Tagami, ``Two-level Named Packet Forwarding for Enhancing the Performance of Virtualized ICN Router,'' to appear in \textit{IEICE Transactions on Communications}, 2019.
