\begin{enumerate}
 \item \underline{J.~Kurihara}, T.~Kubo and T.~Tanaka, ``$\mu$ODNS: A Distributed Approach to DNS Anonymization with Collusion Resistance,'' accepted for publication at \textit{Computer Networks}, Elsevier, 2023.
