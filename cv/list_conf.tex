\begin{enumerate}
 \item R.~Watanabe, A.~Kubota, and \underline{J.~Kurihara}, ``Application of Generalized Deduplication Techniques in Edge Computing Environments,'' to Appear in \textit{Proceedings of the 5-th International Workshop on Multi-Clouds and Mobile Edge Computing (M2EC-2023)}, Juiz de Fora, Brazil, Mar.~29-31, 2023.
% \item R.~Watanabe, A.~Kubota, and \underline{J.~Kurihara}, ``Resource Authorization Methods for Edge Computing,'' in \textit{Proceedings of the 36-th International Conference on Advanced Information Networking and Applications (AINA 2022)}, Sydney, Australia (Virtual), Apr.~13-15, 2022, pp.~167--179.
