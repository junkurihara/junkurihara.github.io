...
\begin{itemize}
\item \hspace*{4ex} \underline{Security, Privacy and Anonymity in DNS}\\[0.5ex]
...
\hspace*{6ex}\begin{minipage}{0.9\linewidth}
He researches and develops coding-theoretic protocols of \emph{private information retrieval} that hides the requester's interests from the server's observation.
\end{minipage}
\end{itemize}
\vspace*{2ex}
