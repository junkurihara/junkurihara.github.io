...
I had been working for KDDI Corp. and KDDI R&D Labs., Inc. (Now KDDI Research, Inc.), Japan from Apr. 2006 to Dec. 2017 as a strategic planner and a researcher for security, applied mathematics and networking architecture.
I had been with Palo Alto Research Center (PARC), CA, USA from 2013 to 2014, and with CyLab, Carnegie Mellon University, PA, USA in 2022 as a visiting researcher.
I received BE, ME, and PhD in Engineering all from Tokyo Institute of Technology in 2004, 2006 and 2012, respectively.

My detailed CV is available [here (PDF)](/cv/cv-en.pdf).
...
- **Mutualized Oblivious DNS (μODNS)**: Anonymized DNS project — [Project page](/dns)
- **rpxy**: A simple and ultrafast reverse-proxy for multiple domain names with TLS termination, written in pure Rust — [GitHub](https://github.com/junkurihara/rust-rpxy) / [https://rpxy.io](https://rpxy.io)
- **rpxy-l4**: A reverse proxy for the layer-4 (TCP+UDP) with protocol multiplexer, written in Rust — [GitHub](https://github.com/junkurihara/rust-rpxy-l4)
- **rust-gd**: A Rust implementation of Generalized Deduplication — [GitHub](https://github.com/junkurihara/rust-gd)
- **jscu**: A Universal Cryptographic Library for JavaScript — [GitHub](https://github.com/junkurihara/jscu)
- See also [my GitHub](https://github.com/junkurihara) for more.
...
- K. Nakano, J. Kurihara and T. Tanaka, ''Extensive study on the security of private information delivery from coded storage,'' IEICE Transactions on Fundamentals of Electronics, Communications and Computer Sciences, vol. E109-A, no. 3, pp. 725--733, Mar. 2026. [Online] Available at [JSTAGE]( https://doi.org/10.1587/transfun.2025EAP1094) (Advance publication). [Supplementary [paper](/repo/sita-2025-paper.pdf) (in English) and [slides](/repo/sita-2025-slides.pdf) (in Japanese) presented in SITA 2025]
...
- Information Literacy 1 & 2 (1Q-2Q, 2026, Undergraduate, Institute of Science Tokyo)
- Security Engineering (Fall, 2020--2025, Graduate School of Information Science, University of Hyogo)
- Network Security (Spring, 2021--2025, Graduate School of Information Science, University of Hyogo)
- Information Security (Spring, 2021--2025, Graduate School of Information Science, University of Hyogo)
- Information Security (Fall 2023--2025, School of Social Information Science, University of Hyogo)
- Information Security (Spring 2020, Graduate School of Applied Informatics, University of Hyogo)
...
- NSF-NICT JUNO 3, 2022--2025 (Co-PI)
- KDDI Foundation Research Grant, 2022--2024 (PI)
- JSPS KAKENHI:
...
Please send me a message through [my LinkedIn page](https://www.linkedin.com/in/junkurihara/), or via email found in my recent papers.
